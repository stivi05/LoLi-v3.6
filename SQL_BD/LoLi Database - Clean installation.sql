...
--
-- Структура таблицы `bonusgen`
--

CREATE TABLE IF NOT EXISTS `bonusgen` (
...
(2, '', '.:: <b>Новости</b> ::.', '', 'b', 2, 1, '', 'block-news.php', 1, '0', 'd', 'ihome,', 'yes'),
...
(54, '', '<b>.:: Рекомендуемые  ::.</b>', '', 'b', 3, 1, '', 'block-recomend.php', 1, '0', 'd', 'browse,', ''),
(24, '', '<b>.:: Календарик ::.</b>', '', 'l', 2, 1, '', 'block-calendarik.php', 1, '0', 'd', 'ihome,', ''),
(25, '', '<b>.:: Наши Герои ::.</b>', '', 'd', 3, 0, '', 'block-heroes.php', 2, '0', 'd', 'ihome,', ''),
(27, '', '<b>.:: Клиенты ::.</b>', '', 'l', 3, 1, '', 'block-clients.php', 1, '0', 'd', 'ihome,', ''),
(33, '', '<b>.:: Посещаемость ::.</b>', '', 'l', 4, 0, '', 'block-statcount.php', 10, '0', 'd', 'ihome,', ''),
(35, '', '<b>.:: Топ 20 ::.</b>', '', 'b', 4, 0, '', 'block-topsecond.php', 1, '0', 'd', 'ihome,', ''),
(37, '', '<b>.:: UA релизы ::.</b>', '', 'r', 2, 1, '', 'block-ua.php', 1, '0', 'd', 'ihome,', ''),
(40, '', '.:: <b>Чатик на главной (chat4)</b> ::.', '', 'b', 5, 1, '', 'block-chat.php', 2, '0', 'd', 'ihome,', ''),
...
(58, '', '<b>.:: Последние 10 релизов ::.</b>', '', 'b', 6, 0, '', 'block-last_reliz.php', 1, '0', 'd', 'ihome,', '');
...
--
-- Дамп данных таблицы `reliz`
--

INSERT INTO `reliz` (`id`, `sort`, `name`, `image`) VALUES
(1, 1, 'WEB-Reliz', 'webrelz.png'),
(2, 2, 'HDClub', 'HDCLUB.gif'),
(3, 3, 'Bluebird-HD', 'blubird.gif');
...
CREATE TABLE IF NOT EXISTS `torrents` (
  ...
  `info_hashs` varbinary(40) DEFAULT NULL,
  `name` varchar(175) NOT NULL DEFAULT '',
...
ALTER TABLE `browse`
  ...
  ADD KEY `seeders` (`seeders`),
  ADD KEY `name` (`name`) USING BTREE,
  ADD KEY `leechers` (`leechers`);
...
--
-- AUTO_INCREMENT для таблицы `browse`
--
ALTER TABLE `browse`
  MODIFY `id` mediumint(7) unsigned NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `orbital_blocks`
  MODIFY `bid` tinyint(2) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=59;
--
...
ALTER TABLE `podarok`
  MODIFY `id` mediumint(7) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `reliz`
--
ALTER TABLE `reliz`
