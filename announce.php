...
$updatebrows[] = 'leechers = leechers + 1';}}}else{
/////////////////////
...
$updatetags[] = 'seeders = seeders + 1';$updatebrows[] = 'seeders = seeders + 1';$updatebrows[] = 'leechers = IF(leechers > 0, leechers - 1, 0)';
}else{$updateset[] = 'leechers = leechers + 1';$updateset[] = 'seeders = IF(seeders > 0, seeders - 1, 0)';
$updatetags[] = 'seeders = IF(seeders > 0, seeders - 1, 0)';$updatebrows[] = 'leechers = leechers + 1';$updatebrows[] = 'seeders = IF(seeders > 0, seeders - 1, 0)';}}
///////////////////
...
$updateset[] = 'leechers = IF(leechers > 0, leechers - 1, 0)';$updatebrows[] = 'leechers = IF(leechers > 0, leechers - 1, 0)';}}
