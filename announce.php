...
$announce_wait = 10;$dt = sqlesc(date('Y-m-d H:i:s', time()));$updateset = array();$snatch_updateset = array();$updatetags = array();$updatebrows = array();
...
$updatetags[] = 'seeders = seeders + 1';$updatebrows[] = 'seeders = seeders + 1';}else{$updateset[] = 'leechers = leechers + 1';$snatch_updateset[] = "seeder = 'no'";
$updatetags[] = 'leechers = leechers + 1';$updatebrows[] = 'leechers = leechers + 1';}}}else{
/////////////////////
...
$updatetags[] = 'seeders = seeders + 1';$updatetags[] = 'leechers = IF(leechers > 0, leechers - 1, 0)';
$updatebrows[] = 'seeders = seeders + 1';$updatebrows[] = 'leechers = IF(leechers > 0, leechers - 1, 0)';
}else{$updateset[] = 'leechers = leechers + 1';$updateset[] = 'seeders = IF(seeders > 0, seeders - 1, 0)';
$updatetags[] = 'leechers = leechers + 1';$updatetags[] = 'seeders = IF(seeders > 0, seeders - 1, 0)';
$updatebrows[] = 'leechers = leechers + 1';$updatebrows[] = 'seeders = IF(seeders > 0, seeders - 1, 0)';}}
///////////////////
...
$updateset[] = 'seeders = IF(seeders > 0, seeders - 1, 0)';$updatetags[] = 'seeders = IF(seeders > 0, seeders - 1, 0)';$updatebrows[] = 'seeders = IF(seeders > 0, seeders - 1, 0)';
}else{
...
$updateset[] = 'leechers = IF(leechers > 0, leechers - 1, 0)';$updatetags[] = 'leechers = IF(leechers > 0, leechers - 1, 0)';
$updatebrows[] = 'leechers = IF(leechers > 0, leechers - 1, 0)';}}
...
$updatetags[] = 'seeders = seeders + 1';$updatebrows[] = 'seeders = seeders + 1';}
...
if(count($updatebrows)) mysql_query('UPDATE LOW_PRIORITY browse SET '.join(", ", $updatebrows).' WHERE id = '.sqlesc($torrentid)) or err('Browse error update');
