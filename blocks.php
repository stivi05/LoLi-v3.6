...
if($_SERVER ["REQUEST_METHOD"] == "GET"){$hidebid = $_COOKIE ["hidebid"];if(empty($_GET["bid"])){stderr($tracker_lang["error"], "<html><head><meta http-equiv=refresh content='0;url=/'></head></html>");} 
