...
list($pagertop, $pagerbottom, $limit) = pager2($limit, $count, "boys.php");
...
.:: Парни нашего трекера <img src='pic/male0.gif'/> :: посмотреть <a class='but' href='girls.php'>Девушки нашего трекера</a> :: или вы хотите посмотреть 
...
c.name, c.flagpic FROM users LEFT JOIN countries AS c ON c.id = users.country WHERE users.gender = '1' $limit";$ress = sql_query($query_string) or die(mysql_error());
...
elseif($arr["uploaded"] > 0) $ratio = "Inf.";else $ratio = "Inf.";$gender = "<img src='pic/male1.gif' alt='Парень' style='margin-left:4pt;border:none;'/>";
...
<center><font style='font-family:tahoma;font-size:14px;font-weight:10;color:red;'><b>НЕТ Парней на сайте, кругом одни бабы! Но гляньте еще на Трансиков! Они везде! 
Возможно они и у нас есть! Интересно? Сверху ссылка!</b></font></center></td></tr></table>";	
