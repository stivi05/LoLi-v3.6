...
if($dsc > 5)break;$ssa = array();$ssa[] = "t.keywords COLLATE UTF8_GENERAL_CI LIKE '%".sqlwildcardesc($dsearchss)."%'";}
...
<table style="background:none;border:0;" class="embedded" align="center"><form method="get" action="browse.php">
