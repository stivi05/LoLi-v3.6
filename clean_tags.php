...
sql_query('INSERT INTO tags (id, name, keywords, description, not_sticky, free, multitracker, seeders, added) SELECT id, name, keywords, description, 
not_sticky, free, multitracker, seeders, added FROM torrents') or sqlerr(__FILE__, __LINE__);
...
owner, free, not_sticky, multitracker, updatess) SELECT id, name, description, category, incategory, size, added, comments, leechers, 
remote_leechers, seeders, remote_seeders, owner, free, not_sticky, multitracker, updatess FROM torrents') or sqlerr(__FILE__, __LINE__);
