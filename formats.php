...
<!-------->
<table style='background:none;border:0;' cellspacing="0" cellpadding="0" width="100%"><tr><td valign='top' style="border: 0px"><div id="tabs">
...
<!-------->
<div id="tabs-1"><table border="0" cellspacing="0" cellpadding="0" width="100%"><ul><b>*.rar / *.zip / *.ace / *.r01 / *.001</b><br>Это самые распространённые расширения архивов.<br>
...
<!-------->
<div id="tabs-2"><table border="0" cellspacing="0" cellpadding="0" width="100%"><ul><b>*.avi / *.mpg. / *.mpeg / *.divx / *.xvid / *.wmv / *.ts / *.m2ts / *.mkv / *.mp4 / *.webm</b><br>
...
<!-------->
<div id="tabs-3"><table border="0" cellspacing="0" cellpadding="0" width="100%"><ul><b>*.bin / *.cue / *.iso</b><br>
...
<!-------->
<div id="tabs-4"><table border="0" cellspacing="0" cellpadding="0" width="100%"><ul><b>*.txt / *.doc</b><br>
...
<!-------->
<div id="tabs-5"><table border="0" cellspacing="0" cellpadding="0" width="100%"> 
