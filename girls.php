...
list($pagertop, $pagerbottom, $limit) = pager($limit, $count, "girls.php?", array('nopage' => true));
...
if(!$arr[avatar]){$avatar=("<a href=users_$arr[id]><img border='0' height='80' title=$arr[username] src='pic/default_avatar.gif'></a>");
}else{$avatar=("<a href=users_$arr[id]><img height='80' src=$arr[avatar] title=$arr[username]></a>");}
...
<table style='background:none;align:center;border:0;' width='240px'><tr><td class='embedded' width='90' style='background:none;align:center;border:0;'><center>$avatar</center></td>
