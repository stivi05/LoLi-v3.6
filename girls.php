...
$res1 = sql_query("SELECT COUNT(id) FROM users WHERE gender = '2'");$row1 = mysql_fetch_array($res1);$count = $row1[0];$limit = 10; //Лимит на одной странице
...
c.name, c.flagpic FROM users LEFT JOIN countries AS c ON c.id = users.country WHERE users.gender = '2' $limit";
