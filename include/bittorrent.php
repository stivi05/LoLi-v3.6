...
$mysql_pass = "пароль пользователя базы данных";
...
$admin_email = 'емайл админа сайта'; // Почта администратора трекера, для формы обратной связи
$website_name = 'Название сайта'; // Краткое имя сайта, для формы обратной связи
...
<script src="js/jquery.js"></script><script src="js/tooltips.js"></script><script src="js/ajaxs.js"></script>
...
//////////////////////////
function is_theme($theme = ""){global $rootpath;return file_exists($rootpath."stdhead.php") && file_exists($rootpath."stdfoot.php");}
/////////////////////////
...
////////////////////////
$cache = new Memcache();$cache->connect('прописать IP вашего сервера!', 11211); // IP вашего сервера и порт Мемкеша
...
else $ip = $remote;$url = getenv("REQUEST_URI");if($ip != 'прописать IP вашего сервера!'){ // прописать IP вашего сервера!
...
@mail($to, $subject, $body, "From: admin@hdclub.top") or $result = false;}
///////////////////////////////
...
header ('Content-Type: text/html; charset=utf-8');header ('X-Powered-by: LoLi v3.5');header ('Cache-Control: public, max-age=86400');	
if(empty($title)){$title = $SITENAME;}else{$title = $SITENAME.' :: '.htmlspecialchars_uni($title);}$ss_uri = select_theme();require_once($rootpath.'stdhead.php');}
////////////////
function stdfoot(){global $CURUSER, $tracker_lang, $queries, $tstart, $query_stat, $querytime, $rootpath;require_once($rootpath.'stdfoot.php');
...
/////////////////////////////
define('NUM_VERSION', '3.6');
define('LoLi', 'Powered by LoLi v'.NUM_VERSION.' Copyright &copy; 2017-'.date('Y'));
//////////////////////////////
...
///////// БОТ В ЧАТЕ ///////////////
function bot_msg($text){$botid = 2;$botclass = 6;$botname = "LoLi";$datee = get_date_time();
