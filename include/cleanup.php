...
function docleanup(){global $autoclean_interval, $points_per_cleanup, $tracker_lang, $maxusers, $rootpath, $CacheBlock;
////////////////////
...
$limitli = 11*1024*1024*1024;$secsn = 46*86400;$dt1 = sqlesc(get_date_time(gmtime() - $secsn));$maxclassn = UC_1080i;
