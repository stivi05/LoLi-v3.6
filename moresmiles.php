...
<?$ctr=0;global $smilies;while((list($code, $url) = each($smilies))){if($count % 5==0) print("<tr>");print("<td align='center' style='background:white'>
<a href=\"javascript: SmileIT('".str_replace("'","\'",$code)."','".htmlentities($_GET["form"])."','".htmlentities($_GET["text"])."')\"><img border='0' src='pic/smilies1/".$url."'></a></td>");
