...
$r = "d".benc_str("files")."d";$fields = "info_hash, times_completed, seeders, leechers";
...
$res = mysql_query($query) or err(mysql_error());while($row = mysql_fetch_assoc($res)){$info_hashd = $row["info_hash"];
