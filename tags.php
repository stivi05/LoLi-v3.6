...
<?/// Спойлер (скрытая информация - картинки, текст) ///////?>
<p class='sub'><b>Спойлер (скрытая информация - картинки, текст)</b></p><table class='main' width='100%' border='1' cellspacing='0' cellpadding='5'><tr valign='top'>
<td width='25%'>Описание:</td><td>Вставка спойлера (скрытая информация - картинки, текст)</td></tr><tr valign='top'><td>Синтаксис:</td><td>
<tt>[spoiler=Скрытая информация]<i>Text</i>[/spoiler]</tt></td></tr><tr valign='top'><td>Пример:</td><td>
<tt>[spoiler=Скрытая информация]Спойлер (скрытая информация - картинки, текст)[/spoiler]</tt></td></tr><tr valign='top'><td>Результат:</td><td>
<details class='desc'><summary data-open='Свернуть' data-close='Скрытая информация'></summary><div class='spoiler'>Спойлер (скрытая информация - картинки, текст)</div></details>
</td></tr></table>
<?/// список - точка ///////?>
