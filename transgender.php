...
list($pagertop, $pagerbottom, $limit) = pager2($limit, $count, "transgender.php?", array('nopage' => true));
...
.:: Трансики нашего трекера <img src='pic/transgenders.gif'/> :: посмотреть <a class='but' href='girls.php'>Девушки нашего трекера</a> :: посмотреть <a class='but' href='boys.php'>Парни нашего трекера</a> ::.</td></tr></table></td></tr></table><?
$dt = gmtime() - 300;$dt = sqlesc(get_date_time($dt));
$query_string = "SELECT users.id, users.username, users.avatar, users.added, users.country, users.downloaded, users.uploaded, users.class, users.birthday, users.last_access, c.name, c.flagpic FROM users LEFT JOIN countries AS c ON c.id = users.country WHERE users.gender = '3' $limit";
...
<table style='background:none;align:center;border:0;' width='240px'><tr><td class='embedded' width='90px' style='background:none;align:center;border:0;'>
<center>$avatar</center></td><td class='embedded' valign='top' align='center' style='background:none;border:0;'><center>
...
<td style='margin-top:7px;width:250px;float:center;border-radius:5px;-webkit-border-radius:5px;-moz-border-radius:5px;-khtml-border-radius:5px;border:1px solid white;display:block;' class='a'><center><font style='font-family:tahoma;font-size:14px;font-weight:10;color:red;'><b>НЕТ Трансиков на сайте, кругом одни НОРМАЛЬНЫЕ ЛЮДИ! Троекратное ура! Пойдем, посмотрим на девчонок? Или брутальных парней? Сверху ссылка!</b></font></center></td></tr></table>";	
