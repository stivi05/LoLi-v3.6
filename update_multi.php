<?php require_once("include/bittorrent.php");dbconn();$old_us = $use_sessions;$use_sessions = 0;$use_sessions = $old_us;
...
stderr2($tracker_lang['error'], "<center>Вы пытаетесь обновить мультитрекер слишком часто. Разрешено это делать не чаще 1 раза в час.</center><html><head><meta http-equiv=refresh content='1;url=details_".$tid."'></head></html>");}
...
stderr2($tracker_lang['success'], "<center>Обновление мультитрекера выполнено успешно. Успешно: $success Ошибок: $errors</center><html><head><meta http-equiv=refresh content='1;url=details_".$tid."'></head></html>");
...
stderr2($tracker_lang['success'], "<center><ul style='margin:0;'>".implode($anns)."</ul>".$update_link."</center><html><head><meta http-equiv=refresh content='1;url=details_".$tid."'></head></html>");
}else{mysql_query("UPDATE torrents SET multitracker = 'no' WHERE id = $tid");
stderr2($tracker_lang['error'], "<center>WTF? Multitracker = YES, but no announces</center><html><head><meta http-equiv=refresh content='1;url=details_".$tid."'></head></html>");}}?>