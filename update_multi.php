...
if ($name == '' || $multitracker == 'no'){stderr2($tracker_lang['error'], "<center>Такого торрента нет, или он не мультитрекерный.</center>");}
...
if(!count($announces_a)){mysql_query("UPDATE torrents SET multitracker = 'no' WHERE id = $tid");}}?>
