...
$perpage = 12;list($pagertop, $pagerbottom, $limit) = pager($perpage, $count, "users?".$q);
...
if(!$arr[avatar]){$avatar=("<a href='userdetails.php?id=".$arr['id']."'><img style='border-radius:5px;border:0;height:80px;' title='".$arr['username']."' src='pic/default_avatar.gif'></a>");
