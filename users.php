...
if(!$arr[avatar]){$avatar = "<a href='user_".$arr['id']."'><img style='border-radius:5px;border:0;height:80px;' title='".$arr['username']."' src='pic/default_avatar.gif'></a>";
}else{$avatar = "<a href='user_".$arr['id']."'><img style='border-radius:5px;border:0;height:80px;' src='".$arr['avatar']."' title='".$arr['username']."'/></a>";}
